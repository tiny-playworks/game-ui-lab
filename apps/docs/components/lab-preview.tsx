          ...
          <div className="lab-preview__stage-inner">
            ...
            <div className="lab-preview__hud">
              ...
              <div className="lab-preview__hud-item">
                ...
                <AbilityBar
                  className="lab-preview__game-ui-fill lab-preview__ability-bar"
              ...
              <div className="lab-preview__hud-item">
                ...
                <CastBar
                  className="lab-preview__game-ui-fill"
                  label={isZh ? "奥术光束" : "Arc Beam"}
                  progress={frame.cast}
                  state={frame.cast >= 1 ? "complete" : "channeling"}
                />
              </div>
              <div className="lab-preview__hud-item">
              ...
              <div className="lab-preview__hud-item">
                ...
                <MiniMap
                  className="lab-preview__game-ui-fill lab-preview__mini-map"
                  label={isZh ? frame.mapLabelZh : frame.mapLabelEn}
                  markers={mapMarkers}
                />
                <LocationTag
              ...
              <div className="lab-preview__hud-item lab-preview__hud-item--wide">
                ...
                <DialogueBox
                  className="lab-preview__game-ui-fill"
                  speaker="Mira"
                  text={isZh ? frame.dialogueZh : frame.dialogueEn}
                  tone={frame.rarity === "rare" ? "warning" : "ally"}
                />
              </div>
