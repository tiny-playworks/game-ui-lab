...
const tokenDefinitions = [
  ...
  token(
    "surfaceStrong",
    "Surface strong",
    "--game-ui-surface-strong",
    "rgba(25, 35, 63, 0.92)",
    "color",
    "colors",
    "surfaceStrong",
    "Raised card and toast surface.",
    "swatch",
  ),
  token(
    "line",
  ...
  token(
    ...
    "colors",
    "muted",
    "Secondary labels and meta text.",
    "text",
  ),
  token(
    "accent",
  ...
  token(
    "accentStrong",
    "Accent strong",
    "--game-ui-accent-strong",
    "#1ee6ff",
    "color",
    "colors",
    "accentStrong",
    "High-energy accent edge.",
    "swatch",
  ),
  token(
    "danger",
  ...
  token(
    ...
    "colors",
    "critical",
    "Critical hit and combo highlight.",
    "swatch",
  ),
  token(
    "miss",
  ...
  token(
    "rarityCommon",
    "Common",
    "--game-ui-rarity-common",
    "#9fb0ce",
    "rarity",
    "colors",
    "rarityCommon",
    "Baseline rarity frame tone.",
    "border",
  ),
  token(
    "rarityRare",
  ...
  token(
    "rarityLegendary",
    "Legendary",
    "--game-ui-rarity-legendary",
    "#ffd166",
    "rarity",
    "colors",
    "rarityLegendary",
    "Top rarity highlight.",
    "border",
  ),
  ...
  token(
    "durationSlow",
    "Slow duration",
    "--game-ui-duration-slow",
    "720ms",
    "motion",
    "durations",
    "slow",
    "Long feedback animation duration.",
    "motion",
  ),
  token(
    "easeOut",
    ...
    "easings",
    "out",
    "Default exit and arrival easing.",
    "motion",
  ),
  ...
  token(
    ...
    "Map line",
    "--game-ui-map-line",
    "rgba(129, 230, 217, 0.22)",
    "map",
    "colors",
    "mapLine",
    "Map grid and frame line.",
    "border",
  ),
  token(
    "markerAlly",
  ...
  token(
    ...
    "colors",
    "slotEmpty",
    "Empty inventory slot surface.",
    "swatch",
  ),
  token(
    "slotEquipped",
    "Slot equipped",
    "--game-ui-slot-equipped",
    "#55f7d2",
    "inventory",
    "colors",
    "slotEquipped",
  ...
  token(
    "partyOffline",
    "Party offline",
    "--game-ui-party-offline",
    "#64748b",
    "party",
    "colors",
    "partyOffline",
    "Offline party member tone.",
    "swatch",
  ),
  token(
    "partySelected",
    "Party selected",
    "--game-ui-party-selected",
    "#55f7d2",
    "party",
    "colors",
    "partySelected",
    "Selected party member accent.",
    "swatch",
  ),
  ...
  token(
    "currencyGold",
    "Currency gold",
    "--game-ui-currency-gold",
    "#ffd166",
    "economy",
    "colors",
    "currencyGold",
    "Gold or coin currency tone.",
    "swatch",
  ),
  token(
    "currencyGem",
    "Currency gem",
    "--game-ui-currency-gem",
    "#b47cff",
    "economy",
    "colors",
    "currencyGem",
    "Premium gem currency tone.",
    "swatch",
  ),
  token(
    "currencyToken",
    "Currency token",
    "--game-ui-currency-token",
    "#55f7d2",
    "economy",
    "colors",
    "currencyToken",
    "Event token currency tone.",
    "swatch",
  ),
...
export function createGameUiThemeCss(themeName: GameUiThemeName) {
  ...
  return tokenDefinitions.flatMap((definition) => {
    ...
    return [`  ${definition.cssVar}: ${value};`, `  ${getPandaCssVar(definition)}: ${value};`];
  });
}
